...
$workspaceId = '27';
$triggerId = '25';
$name = 'Rule-測試-V3-Update-WL';
$type = TriggerType::WINDOW_LOADED;
$parameter = [
    [
        'equals' => [
            ['value' => '{{Page Hostname}}'],
            ['value' => 'www.demo-update.com.tw']
        ],
    ],
    [
        'contains' => [
            ['value' => '{{Page URL}}'],
            ['value' => 'www.demo-2-update.com.tw']
        ]
    ]
];
...
$data = (new Trigger($client))->update($accountId, $containerId, $workspaceId, $triggerId, $trigger);
